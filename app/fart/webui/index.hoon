...
++  build
  ...
  ++  page
    ...
    ;html
      ...
      ;body(onload "odor()")
        ...
        ;p.fart-box(onclick "document.getElementById('poem').style.display='block'")
  ...
  ++  sigil
    ...
    ;div.sigil(style "background-color: #{bg}; width: 20px; height: 20px;")
      ;img@"/fart/sigil.svg?p={(scow %p ship)}&fg={fg}&bg=%23{bg}&icon&size=20";
    ==
  ::
  ++  odor
    '''
